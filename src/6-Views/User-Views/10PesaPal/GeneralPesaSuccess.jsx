...
const GeneralPesaSuccess = () => {
        ...
        let GetTransaction = async (Id) => {
            //console.log("id", Id)
            let getStatus = await axios.get(`${BaseUrl}/v1/payment/pesapal/tansact_statuses?OrderTrackingId=${Id}`, { headers: { "content-type": "application/json" } });
...
export default GeneralPesaSuccess