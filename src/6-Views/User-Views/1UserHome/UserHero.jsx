          ...
          <div className="w-max absolute left-0 bottom-20">
            ...
            >
              ...
              >
                ...
                <Button onClick={()=> filmData?.type === "movie" ? navigate(`/film/${filmData?.id}`) : filmData?.type === 'series' ? navigate(`/series/${filmData?.id}`) : null} className="flex w-max px-8 py-2 items-center justify-center space-x-2 rounded-full relative bg-[#706e72]">
