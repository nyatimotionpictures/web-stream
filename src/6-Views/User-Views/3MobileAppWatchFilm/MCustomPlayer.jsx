...
import MRemainingFilmDays from "./MRemainingFilmDays";
...
const MCustomPlayer = ({
  ...
  return (
    ...
    {purchasedData?.length > 0 && (
        <MRemainingFilmDays videoRef={videoRef} expiryDate={purchasedData[0]?.expiresAt} />
      )}
  </div>
  )
}

export default MCustomPlayer