...
const MSeriesPlayerControls = ({
  ...
  const handleResolutionChange = (video) => {
    if (videoRef.current) {
      ...
      videoRef.current.onloadedmetadata = () => {
        ...
        videoRef.current.play(); // Resume playback if it was playing
  ...
  return (
    ...
    <div className="flex flex-row gap-4 items-center">
      ...
      {/** Next episode */}
      {
        allEpisodes[episodeIndex + 1] !== undefined && (
          <Button onClick={()=> handleNextEpisode(episodeIndex + 1)} className="flex items-center justify-center gap-1 w-max h-max p-2 pl-4 rounded-lg hover:bg-whites-40 bg-transparent   text-base font-[Roboto-Regular] hover:text-secondary-900 ">
          <Typography className="font-[Inter-SemiBold] text-base">Next Episode</Typography> <span className="icon-[rivet-icons--chevron-right] h-5 w-5 "></span>
        </Button>
        )
      }
...
export default MSeriesPlayerControls