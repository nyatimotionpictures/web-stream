...
const FilmPayment = () => {
  ...
  React.useEffect(() => {
    ...
    if (filmsQuery?.data?.film) {
      let filteredPosters = filmsQuery?.data?.film?.posters?.filter((data)=>{
        if(data.isCover){
         return data;
        }
      })
              ...
              <div className="flex flex-col  items-center text-whites-40 gap-4 px-4 md:px-0  md:min-w-[287px]">
                <div className="flex flex-col items-center gap-4 w-full py-6 md:max-w-[500px]   h-full">
                  ...
                  <div className="flex flex-row gap-4 items-center py-2 px-4 bg-[#36323E] md:w-full rounded-lg ">
                    ...
                    <div className="flex flex-col gap-2">
                      <h1 className="font-[Inter-Regular] text-base md:text-2xl text-whites-100 ">
                        Rent: {filmsQuery?.data?.film?.title}
                      </h1>
                      <p className="font-[Inter-Regular] text-sm md:text-xl text-whites-100 ">
                  ...
                  <div className='flex flex-col w-full'>
                    ...
                    <label className={` ${values.option === "mtnmomo" ? "border-2 border-primary-500 bg-opacity-100" : ""} flex flex-row gap-2 items-center min-w-[300px] w-full bg-opacity-40 bg-secondary-400  py-2 px-2 rounded-lg justify-between`}>
                      ...
                      <label className={`${values.option === "airtelmoney" ? "border-2 border-primary-500 bg-opacity-100" : ""} flex flex-row gap-2 items-center min-w-[300px] w-full bg-secondary-400 bg-opacity-40 py-2 px-2 rounded-lg justify-between`}>
                        <div className="flex flex-row gap-2 items-center">
                          <img
                            src={AirtelLogo}
                            alt=""
                      ...
                      <label className={` ${values.option === "visa" ? "border-2 border-primary-500 bg-opacity-100" : ""} flex flex-row gap-2 items-center min-w-[300px] w-full bg-secondary-400 py-2 px-2 bg-opacity-40 rounded-lg justify-between`}>
                        <div className="flex flex-row gap-2 items-center">
                          <img
                            src={PesaPalLogo}
                            alt=""
