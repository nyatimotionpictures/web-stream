...
const BrowseTabFilms = ({
  ...
  const currentItems = allFilteredMovies?.slice(
    indexOfFirstItem,
    indexOfLastItem
  );
  ...
  return (
    <Container className=" h-full relative">
      ...
      {/** pagination */}
      {allFilteredMovies?.length > itemsPerPage && (
         <div className="flex flex-row justify-center items-center gap-2 mt-10 text-whites-40 ">
         <Pagination
           count={Math.ceil(allFilteredMovies?.length / itemsPerPage)}
           page={currentPage}
